...
SELECT band_name, formed FROM metal_bands
ORDER BY formed;

SELECT band_name
FROM metal_bands
WHERE band_name ILIKE '%black%' OR band_name ILIKE '%white%';

SELECT band_name, origin, style, fans
FROM metal_bands
WHERE style ILIKE '%viking folk'
AND origin ILIKE '%german%'
ORDER BY fans DESC;

SELECT band_name, origin, formed, split, fans
FROM metal_bands
WHERE origin = 'USA'
AND split - formed >= 1
AND fans < 10

SELECT band_name, fans, formed, origin, split, style
FROM metal_bands

SELECT DISTINCT band_name, fans, formed, origin, split, style
FROM metal_bands